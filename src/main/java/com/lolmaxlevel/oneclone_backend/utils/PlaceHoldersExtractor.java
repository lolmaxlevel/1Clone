...
public class PlaceHoldersExtractor {
    ...
    public static Map<String, String> getPlaceholdersFromDocument(Document document) {
        ...
        placeholders.put("DATE_END_FULL", DateUtils.formatDateFull(document.getDateTo()));
        placeholders.put("SEQ_NUMBER", String.valueOf(document.getSeqNumber()));
        placeholders.put("CONTRACT_NUMBER", String.valueOf(document.getNumber()));
        return placeholders;
    }
