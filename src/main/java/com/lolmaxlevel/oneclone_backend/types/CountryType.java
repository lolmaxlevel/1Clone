...
public enum CountryType {
    ...
    kz("Республика Казахстан", "Казахстан", "Республики Казахстан"),
    am("Республика Армения", "Армения", "Республики Армения"),
    tj("Республика Таджикистан", "Таджикистан", "Республики Таджикистан"),
    uz("Республика Узбекистан", "Узбекистан", "Республики Узбекистан"),
    ;
